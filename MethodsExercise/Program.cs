...
namespace MethodsExercise
{
    public class Program
    {
        ...
        class Math
        {
            ...
            {
               string answer1 = Convert.ToString( num1 + num2);
            ...
            public static void Divide(double num5, double num6)
            {
                double answer3 = (double)num5 / (double)num6;
                Console.WriteLine($"{answer3}");
            }
            public static void Subtract(int num7, int num8)
            {
